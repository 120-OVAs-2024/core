...
const TrueFalseCarousel: FC<TrueFalseCarouselProps> = ({ questions, text, modal, addClass, ...props }) => {
  const { selectedAnswer, score, validation, currentQuestionIndex, handleNextQuestion, handlePreviousQuestion } =
    useTrueFalseActivityContext();
  ...
  return (
    <>
          ...
          <div className={css['carousel-wrapper']}>
            ...
            <div className={css['activity-wrapper']}>
              ...
              <div className={css['question-container']}>
                <TrueFalseCard
                  interpreter={{
                    contentURL: questions[currentQuestionIndex].contentURL ?? '',
                    a11yURL: questions[currentQuestionIndex].a11yURL ?? ''
                  }}
      ...
      <ModalFeedback
        interpreter={{ contentURL: modal.contentURLCorrect }}
        type="success"
      ...
      <ModalFeedback
        interpreter={{ contentURL: modal.contentURLIncorrect }}
        type="wrong"
